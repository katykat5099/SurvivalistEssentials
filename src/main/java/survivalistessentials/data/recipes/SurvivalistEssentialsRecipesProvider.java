...
public class SurvivalistEssentialsRecipesProvider extends RecipeProvider {
    ...
    public SurvivalistEssentialsRecipesProvider(DataGenerator generatorIn) {
        super(generatorIn);
    }
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        itemPlankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BMO_ANCIENT_OAK_PLANKS, TagManager.Items.BMO_ANCIENT_OAK_LOG, "has_logs", "", "ancient_oak_planks", SurvivalistEssentialsIntegration.BMO_MODID);
        itemPlankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BMO_ANCIENT_OAK_PLANKS, TagManager.Items.BMO_STRIPPED_ANCIENT_OAK_LOG, "has_logs", "", "ancient_oak_planks_stripped", SurvivalistEssentialsIntegration.BMO_MODID);
        itemPlankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BMO_ANCIENT_OAK_PLANKS, TagManager.Items.BMO_ANCIENT_OAK_WOOD, "has_logs", "", "ancient_oak_planks_wood", SurvivalistEssentialsIntegration.BMO_MODID);
        itemPlankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BMO_ANCIENT_OAK_PLANKS, TagManager.Items.BMO_STRIPPED_ANCIENT_OAK_WOOD, "has_logs", "", "ancient_oak_planks_wood_stripped", SurvivalistEssentialsIntegration.BMO_MODID);
        itemPlankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BMO_BLIGHTED_BALSA_PLANKS, TagManager.Items.BMO_BLIGHTED_BALSA_LOG, "has_logs", "", "blighted_balsa_planks", SurvivalistEssentialsIntegration.BMO_MODID);
        itemPlankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BMO_BLIGHTED_BALSA_PLANKS, TagManager.Items.BMO_STRIPPED_BLIGHTED_BALSA_LOG, "has_logs", "", "blighted_balsa_planks_stripped", SurvivalistEssentialsIntegration.BMO_MODID);
        itemPlankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BMO_BLIGHTED_BALSA_PLANKS, TagManager.Items.BMO_BLIGHTED_BALSA_WOOD, "has_logs", "", "blighted_balsa_planks_wood", SurvivalistEssentialsIntegration.BMO_MODID);
        itemPlankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BMO_BLIGHTED_BALSA_PLANKS, TagManager.Items.BMO_STRIPPED_BLIGHTED_BALSA_WOOD, "has_logs", "", "blighted_balsa_planks_wood_stipped", SurvivalistEssentialsIntegration.BMO_MODID);
        itemPlankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BMO_SWAMP_CYPRESS_PLANKS, TagManager.Items.BMO_SWAMP_CYPRESS_LOG, "has_logs", "", "swamp_cypress_planks", SurvivalistEssentialsIntegration.BMO_MODID);
        itemPlankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BMO_SWAMP_CYPRESS_PLANKS, TagManager.Items.BMO_STRIPPED_SWAMP_CYPRESS_LOG, "has_logs", "", "swamp_cypress_planks_stripped", SurvivalistEssentialsIntegration.BMO_MODID);
        itemPlankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BMO_SWAMP_CYPRESS_PLANKS, TagManager.Items.BMO_SWAMP_CYPRESS_WOOD, "has_logs", "", "swamp_cypress_planks_wood", SurvivalistEssentialsIntegration.BMO_MODID);
        itemPlankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BMO_SWAMP_CYPRESS_PLANKS, TagManager.Items.BMO_STRIPPED_SWAMP_CYPRESS_WOOD, "has_logs", "", "swamp_cypress_planks_wood_stripped", SurvivalistEssentialsIntegration.BMO_MODID);
        itemPlankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BMO_WILLOW_PLANKS, TagManager.Items.BMO_WILLOW_LOG, "has_logs", "", "willow_planks", SurvivalistEssentialsIntegration.BMO_MODID);
        itemPlankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BMO_WILLOW_PLANKS, TagManager.Items.BMO_STRIPPED_WILLOW_LOG, "has_logs", "", "willow_planks_stripped", SurvivalistEssentialsIntegration.BMO_MODID);
        itemPlankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BMO_WILLOW_PLANKS, TagManager.Items.BMO_WILLOW_WOOD, "has_logs", "", "willow_planks_wood", SurvivalistEssentialsIntegration.BMO_MODID);
        itemPlankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BMO_WILLOW_PLANKS, TagManager.Items.BMO_STRIPPED_WILLOW_WOOD, "has_logs", "", "willow_planks_wood_stripped", SurvivalistEssentialsIntegration.BMO_MODID);

        //Biomes O' Plenty
        wrapped = withCondition(consumer, new ModLoadedCondition(SurvivalistEssentialsIntegration.BOP_MODID));
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BOP_CHERRY_PLANKS, TagManager.Items.BOP_CHERRY_LOGS, "has_logs");
        ...
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BYG_ETHER_PLANKS, TagManager.Items.BYG_ETHER_LOGS, "has_logs");
        ...
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BYG_LAMENT_PLANKS, TagManager.Items.BYG_LAMENT_LOGS, "has_logs");
        ...
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BYG_CHERRY_PLANKS, TagManager.Items.BYG_CHERRY_LOGS, "has_logs");
        ...
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BYG_NIGHTSHADE_PLANKS, TagManager.Items.BYG_NIGHTSHADE_LOGS, "has_logs");
        ...
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BYG_EMBUR_PLANKS, TagManager.Items.BYG_EMBUR_LOGS, "has_logs");
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BYG_SYTHIAN_PLANKS, TagManager.Items.BYG_SYTHIAN_LOGS, "has_logs");
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BYG_IMPARIUS_PLANKS, TagManager.Items.BYG_IMPARIUS_LOGS, "has_logs");
        plankRecipeBuilder(wrapped, SurvivalistEssentialsIntegration.BYG_BULBIS_PLANKS, TagManager.Items.BYG_BULBIS_LOGS, "has_logs");
        ...
        ShapelessRecipeBuilder.shapeless(Items.OAK_PLANKS, 2)
                ...
                .group("planks")
                .unlockedBy("has_driftwood", has(SurvivalistEssentialsIntegration.AQUA_DRIFTWOOD))
        ...
        ShapelessRecipeBuilder.shapeless(SurvivalistEssentialsIntegration.IE_STICK_TREATED, 2)
        ...
        ShapelessRecipeBuilder.shapeless(SurvivalistEssentialsIntegration.IE_STICK_TREATED, 4)
                .requires(TagManager.Items.IE_TREATED_WOOD)
                .requires(TagManager.Items.IE_TREATED_WOOD)
                .requires(TagManager.Items.ADVANCED_SAW_TOOLS)
                .group("treated_sticks")
    ...
    private static void sticksFromBranchRecipeBuilder(Consumer<FinishedRecipe> consumer, ItemLike item, String modid, String folder, String name) {
        ShapelessRecipeBuilder.shapeless(Items.STICK, 2)
            .requires(item)
            .requires(SurvivalistEssentialsItems.CRUDE_SAW)
            .group("sticks")
            .unlockedBy("has_branch", has(item))
            .save(consumer, new ResourceLocation(modid, folder + name));
