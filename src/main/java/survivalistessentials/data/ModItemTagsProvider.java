...
public class ModItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags() {
        ...
        getBuilder(TagManager.Items.TF_CANOPY_LOGS)
            .addOptional(ModIntegration.tfLoc("canopy_log"));
        getBuilder(TagManager.Items.TF_CANOPY_STRIPPED_LOGS)
            .addOptional(ModIntegration.tfLoc("canopy_stripped_log"));
        getBuilder(TagManager.Items.TF_CANOPY_WOODS)
            .addOptional(ModIntegration.tfLoc("canopy_wood"));
        getBuilder(TagManager.Items.TF_CANOPY_STRIPPED_WOODS)
            .addOptional(ModIntegration.tfLoc("canopy_stripped_wood"));
        getBuilder(TagManager.Items.TF_DARK_LOGS)
            .addOptional(ModIntegration.tfLoc("dark_log"));
        getBuilder(TagManager.Items.TF_DARK_STRIPPED_LOGS)
            .addOptional(ModIntegration.tfLoc("dark_stripped_log"));
        getBuilder(TagManager.Items.TF_DARK_WOODS)
            .addOptional(ModIntegration.tfLoc("dark_wood"));
        getBuilder(TagManager.Items.TF_DARK_STRIPPED_WOODS)
            .addOptional(ModIntegration.tfLoc("dark_stripped_wood"));
        getBuilder(TagManager.Items.TF_MANGROVE_LOGS)
            .addOptional(ModIntegration.tfLoc("mangrove_log"));
        getBuilder(TagManager.Items.TF_MANGROVE_STRIPPED_LOGS)
            .addOptional(ModIntegration.tfLoc("mangrove_stripped_log"));
        getBuilder(TagManager.Items.TF_MANGROVE_WOODS)
            .addOptional(ModIntegration.tfLoc("mangrove_wood"));
        getBuilder(TagManager.Items.TF_MANGROVE_STRIPPED_WOODS)
            .addOptional(ModIntegration.tfLoc("mangrove_stripped_wood"));
        getBuilder(TagManager.Items.TF_MINING_LOGS)
            .addOptional(ModIntegration.tfLoc("mining_log"));
        getBuilder(TagManager.Items.TF_MINING_STRIPPED_LOGS)
            .addOptional(ModIntegration.tfLoc("mining_stripped_log"));
        getBuilder(TagManager.Items.TF_MINING_WOODS)
            .addOptional(ModIntegration.tfLoc("mining_wood"));
        getBuilder(TagManager.Items.TF_MINING_STRIPPED_WOODS)
            .addOptional(ModIntegration.tfLoc("mining_stripped_wood"));
        getBuilder(TagManager.Items.TF_SORTING_LOGS)
            .addOptional(ModIntegration.tfLoc("sorting_log"));
        getBuilder(TagManager.Items.TF_SORTING_STRIPPED_LOGS)
            .addOptional(ModIntegration.tfLoc("sorting_stripped_log"));
        getBuilder(TagManager.Items.TF_SORTING_WOODS)
            .addOptional(ModIntegration.tfLoc("sorting_wood"));
        getBuilder(TagManager.Items.TF_SORTING_STRIPPED_WOODS)
            .addOptional(ModIntegration.tfLoc("sorting_stripped_wood"));
        getBuilder(TagManager.Items.TF_TIME_LOGS)
            .addOptional(ModIntegration.tfLoc("time_log"));
        getBuilder(TagManager.Items.TF_TIME_STRIPPED_LOGS)
            .addOptional(ModIntegration.tfLoc("time_stripped_log"));
        getBuilder(TagManager.Items.TF_TIME_WOODS)
            .addOptional(ModIntegration.tfLoc("time_wood"));
        getBuilder(TagManager.Items.TF_TIME_STRIPPED_WOODS)
            .addOptional(ModIntegration.tfLoc("time_stripped_wood"));
        getBuilder(TagManager.Items.TF_TRANSFORMATION_LOGS)
            .addOptional(ModIntegration.tfLoc("transformation_log"));
        getBuilder(TagManager.Items.TF_TRANSFORMATION_STRIPPED_LOGS)
            .addOptional(ModIntegration.tfLoc("transformation_stripped_log"));
        getBuilder(TagManager.Items.TF_TRANSFORMATION_WOODS)
            .addOptional(ModIntegration.tfLoc("transformation_wood"));
        getBuilder(TagManager.Items.TF_TRANSFORMATION_STRIPPED_WOODS)
            .addOptional(ModIntegration.tfLoc("transformation_stripped_wood"));
        getBuilder(TagManager.Items.TF_TWILIGHT_OAK_LOGS)
            .addOptional(ModIntegration.tfLoc("twilight_oak_log"));
        getBuilder(TagManager.Items.TF_TWILIGHT_OAK_STRIPPED_LOGS)
            .addOptional(ModIntegration.tfLoc("twilight_oak_stripped_log"));
        getBuilder(TagManager.Items.TF_TWILIGHT_OAK_WOODS)
            .addOptional(ModIntegration.tfLoc("twilight_oak_wood"));
        getBuilder(TagManager.Items.TF_TWILIGHT_OAK_STRIPPED_WOODS)
            .addOptional(ModIntegration.tfLoc("twilight_oak_stripped_wood"));
